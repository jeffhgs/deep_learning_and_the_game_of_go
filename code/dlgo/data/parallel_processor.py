...
def worker(jobinfo):
    try:
        clazz, encoder, zip_file, data_file_name, data_directory, game_list = jobinfo
        clazz(encoder=encoder, data_directory=data_directory).process_zip(zip_file, data_file_name, game_list)
        ...
        for zip_name in zip_names:
            ...
            if not os.path.isfile(self.data_dir + '/' + data_file_name):
                zips_to_process.append((self.__class__, self.encoder_string, zip_name,
                                        data_file_name, self.data_dir, indices_by_zip_name[zip_name]))
